    ...
    <AnimatePresence mode="wait">
      ...
      >
        <div className="flex items-center justify-center gap-2 rounded-full border border-white/10 bg-white/80 px-2 py-1.5 shadow-lg shadow-black/10 backdrop-blur-md dark:border-white/10 dark:bg-black/50">
          ...
          {/* CTA Button */}
          <a href="#orzamento" className="relative rounded-full bg-gradient-to-r from-[#8C1BAB] to-[#F761A1] px-4 py-2 text-sm font-medium text-white transition-all hover:shadow-lg hover:shadow-[#F761A1]/20">
            <span>13.345 &euro;</span>
          </a>
        </div>
      </motion.div>
    </AnimatePresence>
